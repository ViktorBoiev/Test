...
<div class="modal fade" id="lottery-modal" tabindex="-1" data-id="" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3>Your prize is <span id="count"></span> <span id="type"></span></h3>
            </div>
            ...
            <div id="modal-preloader" class="preloader justify-content-center align-items-center">
                <svg viewBox="0 0 120 120" width="120px" height="120px">
                    <circle class="inner" cx="60" cy="60" r="32"/>
                    <circle class="middle" cx="60" cy="60" r="38"/>
                    <circle class="outer" cx="60" cy="60" r="44"/>
